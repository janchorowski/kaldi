...
#           2014 Jan Chorowski
# 
# Corpora: a database of polish diphones. S. Grocholewski
#
...
corpora=/pio/data/data/corpora

local/corpora_data_prep.sh $corpora || exit 1

local/corpora_prepare_dict.sh
