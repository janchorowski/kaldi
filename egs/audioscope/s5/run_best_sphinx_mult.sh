...
local/audioscope_best_sphinx_data_prep_mult.sh $audioscope $eksperci || exit 1

local/audioscope_prepare_dict_mult.sh
...
local/audioscope_format_data_mult.sh
...
do
  ...
  steps/decode.sh --nj "$decode_nj" --cmd "$decode_cmd" \
   exp/mono/graph_${lm_suffix} data/dev exp/mono/decode_dev_${lm_suffix}

  steps/decode.sh --nj "$decode_nj" --cmd "$decode_cmd" \
   exp/mono/graph_${lm_suffix} data/test exp/mono/decode_test_${lm_suffix}
done
...
do
  ...
  steps/decode.sh --nj "$decode_nj" --cmd "$decode_cmd" \
   exp/tri1/graph_${lm_suffix} data/dev exp/tri1/decode_dev_${lm_suffix}

  steps/decode.sh --nj "$decode_nj" --cmd "$decode_cmd" \
   exp/tri1/graph_${lm_suffix} data/test exp/tri1/decode_test_${lm_suffix}
done
...
do
  ...
  steps/decode.sh --nj "$decode_nj" --cmd "$decode_cmd" \
   exp/tri2/graph_${lm_suffix} data/dev exp/tri2/decode_dev_${lm_suffix}

  steps/decode.sh --nj "$decode_nj" --cmd "$decode_cmd" \
   exp/tri2/graph_${lm_suffix} data/test exp/tri2/decode_test_${lm_suffix}
done
...
do
  ...
  steps/decode_fmllr.sh --nj "$decode_nj" --cmd "$decode_cmd" \
   exp/tri3/graph_${lm_suffix} data/dev exp/tri3/decode_dev_${lm_suffix}

  steps/decode_fmllr.sh --nj "$decode_nj" --cmd "$decode_cmd" \
   exp/tri3/graph_${lm_suffix} data/test exp/tri3/decode_test_${lm_suffix}
done
...
do
  ...
  steps/decode_sgmm2.sh --nj "$decode_nj" --cmd "$decode_cmd" \
   ...
   exp/sgmm2_4/graph_${lm_suffix} data/dev exp/sgmm2_4/decode_dev_${lm_suffix}

  steps/decode_sgmm2.sh --nj "$decode_nj" --cmd "$decode_cmd" \
   --transform-dir exp/tri3/decode_test_${lm_suffix} \
   exp/sgmm2_4/graph_${lm_suffix} data/test exp/sgmm2_4/decode_test_${lm_suffix}
done
...
do
  for iter in 1 2 3 4; do
    steps/decode_sgmm2_rescore.sh --cmd "$decode_cmd" --iter $iter \
     --transform-dir exp/tri3/decode_dev_${lm_suffix} \
     data/lang_test_${lm_suffix} data/dev exp/sgmm2_4/decode_dev_${lm_suffix} \
     exp/sgmm2_4_mmi_b0.1/decode_dev_it${iter}_${lm_suffix}

    steps/decode_sgmm2_rescore.sh --cmd "$decode_cmd" --iter $iter \
     --transform-dir exp/tri3/decode_test_${lm_suffix} \
     data/lang_test_${lm_suffix} data/test exp/sgmm2_4/decode_test_${lm_suffix} \
...
do
  ...
  steps/nnet2/decode.sh --cmd "$decode_cmd" --nj "$decode_nj" "${decode_extra_opts[@]}" \
    --transform-dir exp/tri3/decode_dev_${lm_suffix} exp/tri3/graph_${lm_suffix} data/dev \
  ...
  steps/nnet2/decode.sh --cmd "$decode_cmd" --nj "$decode_nj" "${decode_extra_opts[@]}" \
    --transform-dir exp/tri3/decode_test_${lm_suffix} exp/tri3/graph_${lm_suffix} data/test \
...
do
  for iter in 1 2 3 4; do
    local/score_combine.sh --cmd "$decode_cmd" \
     data/dev data/lang_test_${lm_suffix} exp/tri4_nnet/decode_dev_${lm_suffix} \
     exp/sgmm2_4_mmi_b0.1/decode_dev_it${iter}_${lm_suffix} \
     exp/combine_2/decode_dev_it${iter}_${lm_suffix}

    local/score_combine.sh --cmd "$decode_cmd" \
     data/test data/lang_test_${lm_suffix} exp/tri4_nnet/decode_test_${lm_suffix} \
     exp/sgmm2_4_mmi_b0.1/decode_test_it${iter}_${lm_suffix} \
